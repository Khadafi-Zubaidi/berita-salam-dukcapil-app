...
<body class="homepage-v2">
  ...
  <main>
    ...
    <div class="container mt-5 pt-3">
      ...
      <h2 class="text-center font-weight-medium dark-grey-text py-3">
        <strong>Dinas Kependudukan dan Pencatatan Sipil</strong>
      </h2>
      <hr>
      <!-- Grid row -->
    </div>
    <div class="container mt-5 pt-3">
        <h2 class="text-center font-weight-bold dark-grey-text py-3">
          ...
          <h4 class="text-center font-weight-medium dark-grey-text py-3">
            Terwujudnya Pelayanan Prima Serta Tertib Administrasi Kependudukan Berbasis Teknologi Informasi
          </h4>
    </div>
    <div class="container mt-5 pt-3">
        <h2 class="text-center font-weight-bold dark-grey-text py-3">
          ...
          <h4 class="font-weight-medium dark-grey-text py-3">
            <ol>
                <li>Meningkatkan Pelayanan Di Bidang Pelayanan Pendaftaran Penduduk Yang Cepat, Akurat, Mudah, Transparan Serta Akuntabel</li>
                <li>Meningkatkan Pelayanan Di Bidang Pencatatan Sipil Yang Cepat, Akurat, Mudah, Transparan Serta Akuntabel</li>
                <li>Meningkatkan Pengelolaan Database Kependudukan dan Pencatatan Sipil Melalui Optimalisasi Sistem Informasi Administrasi Kependudukan (SIAK)</li>
                <li>Meningkatkan Pemanfaatan Database Kependudukan dan Pencatatan Sipil Melalui Inovasi Pelayanan</li>
            </ol>
          </h4>
    </div>
