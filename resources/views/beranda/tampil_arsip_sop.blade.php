        ...
        <section>
            <div class="col-md-12">
              ...
              <div class="text-center mb-2 mt-2">
                <hr>  
                <h3>Arsip Standar Operasional dan Prosedur</h3>
                <hr>  
              </div>
                <div class="card">
                    <div class="card-body">
                        <table id="example1" class="table table-striped" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                @php $no = 1; @endphp
                                @foreach($DataSOP as $dsop)
                                <tr>
                                    <td>{{$no++}}</td>
                                    <td>{!! $dsop->nama_sop !!}</td>
                                    <td>
                                        <a href="/sop/{{$dsop->berkas}}" target="_blank" class="btn btn-success btn-block btn-sm">Lihat Berkas</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
