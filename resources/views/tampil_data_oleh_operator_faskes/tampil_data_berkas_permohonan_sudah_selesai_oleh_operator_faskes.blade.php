                                                        ...
                                                        @foreach($DataTabel as $dt)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="{{action('App\Http\Controllers\BerkasPermohonanDariFaskesController@cetak_bukti_pendaftaran_oleh_operator_faskes', $dt->id)}}" class="btn btn-info btn-block btn-sm"><small>Cetak Bukti Pendaftaran</small></a>
                                                                    <a href="{{action('App\Http\Controllers\BerkasPermohonanDariFaskesController@cetak_bukti_pengambilan_oleh_operator_faskes', $dt->id)}}" class="btn btn-danger btn-block btn-sm"><small>Cetak Bukti Pengambilan Dokumen</small></a>
                                                                </td>
                                                            </tr>
