                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{route('tampil_data_berita_oleh_reporter')}}" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="{{route('logout_reporter')}}" class="nav-link">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Rekapitulasi Data Jumlah Berita</h5>
                                        <div class="card-tools">
                                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                                <i class="fas fa-minus"></i>
                                            </button>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Profile Reporter</h5>
                                        <div class="card-tools">
                                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                                <i class="fas fa-minus"></i>
                                            </button>
                                                    ...
                                                    <div class="card-body box-profile">
                                                        <div class="text-center">
                                                            <img class="profile-user-img img-fluid img-circle"
                                                                 src="{{asset('foto_reporter')}}/{{$LoggedUserInfo->foto}}"
                                                    ...
                                                    <div class="card-body">
                                                        <div class="tab-content">
                                                            <div class="active tab-pane" id="ubah-profile">
                                                                <form method="post" action="{{route('simpan_perubahan_data_profil_reporter')}}">
                                                                    @csrf
                                                            ...
                                                            <div class="tab-pane" id="ubah-password">
                                                                <form method="post" action="{{route('simpan_perubahan_data_password_reporter')}}">
                                                                    @csrf
                                                                    <input name="id" type="hidden" class="form-control" value="{{$LoggedUserInfo->id}}">
                                                                    <div class="form-group">
                                                            ...
                                                            <div class="tab-pane" id="ubah-foto">
                                                                <form method="post" action="{{route('simpan_perubahan_data_foto_reporter')}}" enctype="multipart/form-data">
                                                                    @csrf
                                                                    <input name="id" type="hidden" class="form-control" value="{{$LoggedUserInfo->id}}">
