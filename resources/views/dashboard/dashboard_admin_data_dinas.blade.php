                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{route('tampil_data_berkas_permohonan_dari_desa_belum_selesai_oleh_admin_data_dinas')}}" class="nav-link">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('tampil_data_berkas_permohonan_dari_desa_sudah_selesai_oleh_admin_data_dinas')}}" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>
                                                Sudah Selesai
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{route('tampil_data_berkas_permohonan_dari_faskes_belum_selesai_oleh_admin_data_dinas')}}" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>
                                                Belum Selesai
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('tampil_data_berkas_permohonan_dari_faskes_sudah_selesai_oleh_admin_data_dinas')}}" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>
                                                Sudah Selesai
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{route('tampil_data_berkas_permohonan_dari_kua_belum_selesai_oleh_admin_data_dinas')}}" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>
                                                Belum Selesai
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('tampil_data_berkas_permohonan_dari_kua_sudah_selesai_oleh_admin_data_dinas')}}" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>
                                                Sudah Selesai
                            ...
                            <li class="nav-item">
                                <a href="{{route('logout_admin_data_dinas')}}" class="nav-link">
