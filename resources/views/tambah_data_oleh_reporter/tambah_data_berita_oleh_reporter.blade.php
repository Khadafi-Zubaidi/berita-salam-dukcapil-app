                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Pemasukan Data Berita</h5>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form action="{{route('simpan_data_baru_berita_oleh_reporter')}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="tanggal_berita" class="form-control @error('tanggal_berita') is-invalid @enderror" value="{{ old('tanggal_berita')}}">
                                                        <div class="input-group-append">
                                                            <div class="input-group-text">
                                                                <span class="fas fa-id-card"></span>
                                                            </div>
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <div class="input-group mb-3">
                                                            <!--<textarea name="isi_berita" rows="5" cols="100"></textarea>-->
