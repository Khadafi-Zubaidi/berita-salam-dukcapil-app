                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            <li class="nav-item">
                                <a href="{{route('tambah_data_kua_oleh_admin_data')}}" class="nav-link">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Data KUA</h5>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach($DataTabel as $dt)
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form id="Form1" action="" method="post">
                                                                                ...
                                                                                <div class="input-group mb-3">
                                                                                    <input type="text" id="nama_kua1" class="form-control" required>
                                                            ...
                                                            <script>
                                                                ...
                                                                {
                                                                    $.get('/kua/'+id,function(kua){
                                                                        $("#id1").val(kua.id);
                                                                        $("#nama_kua1").val(kua.nama_kua);
                                                                        $("#Modal1").modal('toggle');
                                                                    })
                                                                    $("#Form1").submit(function (e){
                                                                        e.preventDefault();
                                                                        let id = $("#id1").val();
                                                                        let nama_kua = $("#nama_kua1").val();
                                                                        let _token = $("input[name=_token]").val();
                                                                        $.ajax({
                                                                            url:"{{route('kua.perbaharui_data')}}",
                                                                            type: "PUT",
                                                                            data:{
                                                                                id:id,
                                                                                nama_kua:nama_kua,
                                                                            ...
                                                                            success:function(response){
                                                                                $("#Modal1").modal('hide');
                                                                                window.location = "{{route('tampil_data_kua_oleh_admin_data')}}";
                                                                            }
                                                                        })
                                                                    })
                                                                }
