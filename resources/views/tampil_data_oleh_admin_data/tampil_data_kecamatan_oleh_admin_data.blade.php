                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            <li class="nav-item">
                                <a href="{{route('tambah_data_kecamatan_oleh_admin_data')}}" class="nav-link">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach($DataTabel as $dt)
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content bg-warning">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title">Lihat Data Kecamatan</h4>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form id="ubahDataForm" action="" method="post">
                                                                                ...
                                                                                <div class="input-group mb-3">
                                                                                    <input type="text" id="kode_wilayah_kecamatan1" class="form-control" disabled>
                                                                                ...
                                                                                <div class="input-group mb-3">
                                                                                    <input type="text" id="nama_kecamatan1" class="form-control" required>
                                                                                    <div class="input-group-append">
                                                                                        <div class="input-group-text">
                                                                                            <span class="fas fa-id-card"></span>
                                                                                        </div>
                                                            ...
                                                            <script>
                                                                ...
                                                                {
                                                                    $.get('/kecamatans/'+id,function(kecamatan){
                                                                        $("#id1").val(kecamatan.id);
                                                                        $("#kode_wilayah_kecamatan1").val(kecamatan.kode_wilayah_kecamatan);
                                                                        $("#nama_kecamatan1").val(kecamatan.nama_kecamatan);
                                                                        $("#ubahDataModal").modal('toggle');
                                                                    })
                                                                    $("#ubahDataForm").submit(function (e){
                                                                        e.preventDefault();
                                                                        let id = $("#id1").val();
                                                                        let nama_kecamatan = $("#nama_kecamatan1").val();
                                                                        let _token = $("input[name=_token]").val();
                                                                        $.ajax({
                                                                            url:"{{route('kecamatan.updatedata')}}",
                                                                            type: "PUT",
                                                                            data:{
                                                                                id:id,
                                                                            ...
                                                                            success:function(response){
                                                                                ...
                                                                                window.location = "{{route('tampil_data_kecamatan_oleh_admin_data')}}";
                                                                            }
                                                                        })
                                                                    })
                                                                }
