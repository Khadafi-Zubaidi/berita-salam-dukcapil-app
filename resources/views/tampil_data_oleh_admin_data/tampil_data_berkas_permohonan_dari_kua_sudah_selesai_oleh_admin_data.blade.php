                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Data Berkas Permohonan Dari Operator KUA</h5>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach($DataTabel as $dt)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="/berkas_permohonan_dari_kua_selesai/{{$dt->berkas_selesai}}" class="btn btn-success btn-block btn-sm"><small>Unduh Dokumen Hasil</small></a>
                                                            ...
                                                            <script>
                                                                function hapusBerkasPermohonanSelesai(id)
                                                                {
                                                                    $.get('/berkas_permohonan_dari_kua/'+id,function(berkas_permohonan_dari_kua){
                                                                        ...
                                                                        $("#berkas_permohonan1").val(berkas_permohonan_dari_kua.berkas_permohonan);
                                                                    ...
                                                                    $("#ubahDataForm").submit(function (e){
                                                                        ...
                                                                        $.ajax({
                                                                            url:"{{route('hapus_berkas_permohonan_dari_kua_ok')}}",
                                                                            type: "PUT",
                                                                            data:{
                                                                                id:id,
                                                                            ...
                                                                            success:function(response){
                                                                                ...
                                                                                window.location = "{{route('tampil_data_berkas_permohonan_dari_kua_sudah_selesai_oleh_admin_data')}}";
                                                                            }
                                                                        })
                                                                    })
                                                                }
                                                            ...
                                                            <script>
                                                                function ubahDataCanting(id)
                                                                {
                                                                    $.get('/berkas_permohonan_dari_kua/'+id,function(berkas_permohonan_dari_kua){
                                                                        ...
                                                                        $("#dokumen_hasil2").summernote('code', berkas_permohonan_dari_kua.dokumen_hasil);
                                                                        $("#jml_kk2").val(berkas_permohonan_dari_kua.jml_kk);
                                                                        $("#jml_skp2").val(berkas_permohonan_dari_kua.jml_skp);
                                                                        $("#jml_kia2").val(berkas_permohonan_dari_kua.jml_kia);
                                                                        $("#jml_akta_kelahiran2").val(berkas_permohonan_dari_kua.jml_akta_kelahiran);
                                                                        $("#jml_akta_kematian2").val(berkas_permohonan_dari_kua.jml_akta_kematian);
                                                                        $("#jml_lain_lain2").val(berkas_permohonan_dari_kua.jml_lain_lain);
                                                                        $("#Modal8").modal('toggle');
                                                                    })
                                                                    $("#Form8").submit(function (e){
                                                                        ...
                                                                        if($('#jml_kk2').val() == '0'&&
                                                                        ...
                                                                        else
                                                                            {
                                                                                ...
                                                                                let _token = $("input[name=_token]").val();
                                                                                $.ajax({
                                                                                    url:"{{route('berkas_permohonan_dari_kua.isi_canting')}}",
                                                                                    type: "PUT",
                                                                                    data:{
                                                                                        id:id,
