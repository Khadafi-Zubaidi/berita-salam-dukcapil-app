                                                            ...
                                                            <script>
                                                                function unggahBerkasPermohonanSelesai(id)
                                                                {
                                                                    ...
                                                                    $("#editDataFotoForm").submit(function (e){
                                                                        ...
                                                                        $.ajax({
                                                                            url:"{{route('berkas_permohonan_dari_kua.upload_berkas_permohonan_selesai')}}",
                                                                            type: "POST",
                                                                            data: formData,
                                                                            cache:false,
                                                                            contentType: false,
                                                                            ...
                                                                            success: (data) =>{
                                                                                ...
                                                                                window.location = "{{route('tampil_data_berkas_permohonan_dari_kua_belum_selesai_oleh_admin_data_dinas')}}";
                                                                            }
                                                                        });
                                                                    });
                                                                }
