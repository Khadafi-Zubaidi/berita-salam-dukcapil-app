                                                ...
                                                <table id="example1" class="table table-bordered table-striped" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach($DataTabel as $dt)
                                                            ...
                                                            <!-- Unggah Berkas Permohonan Selesai -->
                                                            ...
                                                            <script>
                                                                ...
                                                                {
                                                                    $.get('/cari_berkas_pengurusan_oleh_admin_data_dinas/'+id,function(berkas_pengurusan){
                                                                    ...
                                                                    $("#editDataFotoForm").submit(function (e){
                                                                        ...
                                                                        $.ajax({
                                                                            url:"{{route('berkas_permohonan.upload_berkas_permohonan_selesai_oleh_admin_data_dinas')}}",
                                                                            type: "POST",
                                                                            data: formData,
                                                                            cache:false,
                                                                            contentType: false,
                                                                            ...
                                                                            success: (data) =>{
                                                                                ...
                                                                                window.location = "{{route('tampil_data_berkas_permohonan_dari_desa_belum_selesai_oleh_admin_data_dinas')}}";
                                                                            }
                                                                        });
                                                                    });
                                                                }
                                                                ...
                                                                function ubahDataCanting(id)
                                                                {
                                                                    ...
                                                                    $("#ubahDataForm").submit(function (e){
                                                                        ...
                                                                        if($('#jml_kk2').val() == '0'&&
                                                                            ...
                                                                            $.ajax({
                                                                                url:"{{route('berkas_permohonan.isi_canting_oleh_admin_data_dinas')}}",
                                                                                type: "PUT",
                                                                                data:{
                                                                                    id:id,
