                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            <li class="nav-item">
                                <a href="{{route('tambah_data_akuntabilitas_kinerja_oleh_redaktur')}}" class="nav-link">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Data Akuntabilitas Kinerja</h5>
                                                        ...
                                                        @foreach($DataTabel as $dt)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="/akuntabilitas_kinerja/{{$dt->berkas}}" target="_blank" class="btn btn-success btn-block btn-sm">Lihat Berkas</a>
                                                            ...
                                                            <script>
                                                                ...
                                                                {
                                                                    $.get('/akuntabilitas_kinerja/'+id,function(akuntabilitas_kinerja){
                                                                        $("#id1").val(akuntabilitas_kinerja.id);
                                                                        $("#judul1").summernote('code', akuntabilitas_kinerja.judul);
                                                                    ...
                                                                    $("#ubahDataForm").submit(function (e){
                                                                        ...
                                                                        $.ajax({
                                                                            url:"{{route('akuntabulitas_kinerja.update_data')}}",
                                                                            type: "PUT",
                                                                            data:{
                                                                                id:id,
                                                                                judul:judul,
                                                                            ...
                                                                            success:function(response){
                                                                                ...
                                                                                window.location = "{{route('tampil_data_akuntabilitas_kinerja_oleh_redaktur')}}";
                                                                            }
                                                                        })
                                                                    })
                                                                }
                                                            ...
                                                            <script>
                                                                ...
                                                                {
                                                                    $.get('/akuntabilitas_kinerja/'+id,function(akuntabilitas_kinerja){
                                                                        $("#id2").val(akuntabilitas_kinerja.id);
                                                                    ...
                                                                    $("#editDataFotoForm").submit(function (e){
                                                                        ...
                                                                        $.ajax({
                                                                            url:"{{route('akuntabulitas_kinerja.update_berkas')}}",
                                                                            type: "POST",
                                                                            data: formData,
                                                                            cache:false,
                                                                            contentType: false,
                                                            ...
                                                            <script>
                                                                ...
                                                                {
                                                                    $.get('/akuntabilitas_kinerja/'+id,function(akuntabilitas_kinerja){
                                                                        $("#id3").val(akuntabilitas_kinerja.id);
                                                                        $("#berkas3").val(akuntabilitas_kinerja.berkas);
                                                                        $("#judul3").summernote('code', akuntabilitas_kinerja.judul);
                                                                    ...
                                                                    $("#hapusDataForm").submit(function (e){
                                                                        ...
                                                                        let _token = $("input[name=_token]").val();
                                                                        $.ajax({
                                                                            url:"{{route('akuntabulitas_kinerja.delete_data')}}",
                                                                            type: "PUT",
                                                                            data:{
                                                                                id:id,
                                                                                berkas:berkas,
