                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            <li class="nav-item">
                                <a href="{{route('tambah_data_agregat_kependudukan_semester_satu_oleh_redaktur')}}" class="nav-link">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Data Agregat Kependudukan Semester Satu</h5>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach($DataTabel as $dt)
                                                            ...
                                                            <script>
                                                                ...
                                                                {
                                                                    $.get('/agregat_kependudukan_semester_satu/'+id,function(agregat_kependudukan_semester_satu){
                                                                        $("#id1").val(agregat_kependudukan_semester_satu.id);
                                                                        $("#judul1").summernote('code', agregat_kependudukan_semester_satu.judul);
                                                                    ...
                                                                    $("#ubahDataForm").submit(function (e){
                                                                        ...
                                                                        $.ajax({
                                                                            url:"{{route('agregat_kependudukan_semester_satu.update_data')}}",
                                                                            type: "PUT",
                                                                            data:{
                                                                                id:id,
                                                                                judul:judul,
                                                                            ...
                                                                            success:function(response){
                                                                                ...
                                                                                window.location = "{{route('tampil_data_agregat_kependudukan_semester_satu_oleh_redaktur')}}";
                                                                            }
                                                                        })
                                                                    })
                                                                }
                                                            ...
                                                            <script>
                                                                ...
                                                                {
                                                                    $.get('/agregat_kependudukan_semester_satu/'+id,function(agregat_kependudukan_semester_satu){
                                                                        $("#id2").val(agregat_kependudukan_semester_satu.id);
                                                                    ...
                                                                    $("#editDataFotoForm").submit(function (e){
                                                                        ...
                                                                        $.ajax({
                                                                            url:"{{route('agregat_kependudukan_semester_satu.update_berkas')}}",
                                                                            type: "POST",
                                                                            data: formData,
                                                                            cache:false,
                                                                            contentType: false,
                                                            ...
                                                            <script>
                                                                ...
                                                                {
                                                                    $.get('/agregat_kependudukan_semester_satu/'+id,function(agregat_kependudukan_semester_satu){
                                                                        $("#id3").val(agregat_kependudukan_semester_satu.id);
                                                                        $("#berkas3").val(agregat_kependudukan_semester_satu.berkas);
                                                                        $("#judul3").summernote('code', agregat_kependudukan_semester_satu.judul);
                                                                    ...
                                                                    $("#hapusDataForm").submit(function (e){
                                                                        ...
                                                                        let _token = $("input[name=_token]").val();
                                                                        $.ajax({
                                                                            url:"{{route('agregat_kependudukan_semester_satu.delete_data')}}",
                                                                            type: "PUT",
                                                                            data:{
                                                                                id:id,
                                                                                berkas:berkas,
