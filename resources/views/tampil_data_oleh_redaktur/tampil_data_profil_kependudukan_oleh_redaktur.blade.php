                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            <li class="nav-item">
                                <a href="{{route('tambah_data_profil_kependudukan_oleh_redaktur')}}" class="nav-link">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Data Profil Kependudukan</h5>
                                                        ...
                                                        @foreach($DataTabel as $dt)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="/profil_kependudukan/{{$dt->berkas}}" target="_blank" class="btn btn-success btn-block btn-sm">Lihat Berkas</a>
                                                            ...
                                                            <script>
                                                                ...
                                                                {
                                                                    $.get('/profil_kependudukan/'+id,function(profil_kependudukan){
                                                                        $("#id1").val(profil_kependudukan.id);
                                                                        $("#judul1").summernote('code', profil_kependudukan.judul);
                                                                    ...
                                                                    $("#ubahDataForm").submit(function (e){
                                                                        ...
                                                                        $.ajax({
                                                                            url:"{{route('profil_kependudukan.update_data')}}",
                                                                            type: "PUT",
                                                                            data:{
                                                                                id:id,
                                                                                judul:judul,
                                                                            ...
                                                                            success:function(response){
                                                                                ...
                                                                                window.location = "{{route('tampil_data_profil_kependudukan_oleh_redaktur')}}";
                                                                            }
                                                                        })
                                                                    })
                                                                }
                                                            ...
                                                            <script>
                                                                ...
                                                                {
                                                                    $.get('/profil_kependudukan/'+id,function(profil_kependudukan){
                                                                        $("#id2").val(profil_kependudukan.id);
                                                                    ...
                                                                    $("#editDataFotoForm").submit(function (e){
                                                                        ...
                                                                        $.ajax({
                                                                            url:"{{route('profil_kependudukan.update_berkas')}}",
                                                                            type: "POST",
                                                                            data: formData,
                                                                            cache:false,
                                                                            contentType: false,
                                                            ...
                                                            <script>
                                                                ...
                                                                {
                                                                    $.get('/profil_kependudukan/'+id,function(profil_kependudukan){
                                                                        $("#id3").val(profil_kependudukan.id);
                                                                        $("#berkas3").val(profil_kependudukan.berkas);
                                                                        $("#judul3").summernote('code', profil_kependudukan.judul);
                                                                    ...
                                                                    $("#hapusDataForm").submit(function (e){
                                                                        ...
                                                                        let _token = $("input[name=_token]").val();
                                                                        $.ajax({
                                                                            url:"{{route('profil_kependudukan.delete_data')}}",
                                                                            type: "PUT",
                                                                            data:{
                                                                                id:id,
                                                                                berkas:berkas,
