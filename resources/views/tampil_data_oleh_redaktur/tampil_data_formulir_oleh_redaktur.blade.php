                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            <li class="nav-item">
                                <a href="{{route('tambah_data_formulir_oleh_redaktur')}}" class="nav-link">
                                                        ...
                                                        @foreach($DataTabel as $dt)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="/formulir/{{$dt->berkas}}" target="_blank" class="btn btn-success btn-block btn-sm">Lihat Berkas</a>
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content bg-warning">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title">Ubah Data Formulir</h4>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form id="ubahDataForm" action="" method="post">
                                                                                ...
                                                                                <div class="input-group mb-3">
                                                                                    <textarea id="nama_formulir1"></textarea>
                                                                                </div>
                                                                                <div class="col-12">
                                                            ...
                                                            <script>
                                                                ...
                                                                {
                                                                    $.get('/formulirs/'+id,function(formulir){
                                                                        $("#id1").val(formulir.id);
                                                                        $("#nama_formulir1").summernote('code', formulir.nama_formulir);
                                                                        $("#ubahDataModal").modal('toggle');
                                                                    })
                                                                    $("#ubahDataForm").submit(function (e){
                                                                        e.preventDefault();
                                                                        let id = $("#id1").val();
                                                                        let nama_formulir = $("#nama_formulir1").val();
                                                                        let _token = $("input[name=_token]").val();
                                                                        $.ajax({
                                                                            url:"{{route('formulir.updatedata')}}",
                                                                            type: "PUT",
                                                                            data:{
                                                                                id:id,
                                                                            ...
                                                                            success:function(response){
                                                                                ...
                                                                                window.location = "{{route('tampil_data_formulir_oleh_redaktur')}}";
                                                                            }
                                                                        })
                                                                    })
                                                                }
                                                                    ...
                                                                    <div class="modal-content bg-danger">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form id="hapusDataForm" action="" method="post">
                                                                                ...
                                                                                <label>Nama Formulir *</label><br>
                                                                                <div class="input-group mb-3">
                                                                                    <input type="text" id="nama_formulir6" class="form-control" disabled>
                                                                                </div>
                                                                                <div class="col-12">
                                                            ...
                                                            <script>
                                                                function hapusData(id)
                                                                {
                                                                    $.get('/formulirs/'+id,function(formulir){
                                                                        $("#id6").val(formulir.id);
                                                                        $("#nama_formulir6").summernote('code', formulir.nama_formulir);
