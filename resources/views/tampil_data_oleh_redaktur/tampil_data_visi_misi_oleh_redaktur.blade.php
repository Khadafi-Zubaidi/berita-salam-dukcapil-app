                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            <li class="nav-item">
                                <a href="{{route('tambah_data_visi_misi_oleh_redaktur')}}" class="nav-link">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Data Visi dan Misi</h5>
                                                        ...
                                                        @foreach($DataTabel as $dt)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="/visi_misi/{{$dt->berkas}}" target="_blank" class="btn btn-success btn-block btn-sm">Lihat Berkas</a>
                                                            ...
                                                            <script>
                                                                ...
                                                                {
                                                                    $.get('/visi_misi/'+id,function(visi_misi){
                                                                        $("#id1").val(visi_misi.id);
                                                                        $("#judul1").summernote('code', visi_misi.judul);
                                                                    ...
                                                                    $("#ubahDataForm").submit(function (e){
                                                                        ...
                                                                        $.ajax({
                                                                            url:"{{route('visi_misi.update_data')}}",
                                                                            type: "PUT",
                                                                            data:{
                                                                                id:id,
                                                                                judul:judul,
                                                                            ...
                                                                            success:function(response){
                                                                                ...
                                                                                window.location = "{{route('tampil_data_visi_misi_oleh_redaktur')}}";
                                                                            }
                                                                        })
                                                                    })
                                                                }
                                                                    ...
                                                                    <div class="modal-content bg-info">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form id="editDataFotoForm" action="" method="post" enctype="multipart/form-data">
                                                                                ...
                                                                                <label>Upload File (JPG)</label><br>
                                                                                <div class="input-group mb-3">
                                                            ...
                                                            <script>
                                                                function editDataFoto(id)
                                                                {
                                                                    ...
                                                                    $("#editDataFotoForm").submit(function (e){
                                                                        ...
                                                                        $.ajax({
                                                                            url:"{{route('visi_misi.update_berkas')}}",
                                                                            type: "POST",
                                                                            data: formData,
                                                                            cache:false,
                                                                            contentType: false,
                                                            ...
                                                            <script>
                                                                ...
                                                                {
                                                                    $.get('/visi_misi/'+id,function(visi_misi){
                                                                        $("#id3").val(visi_misi.id);
                                                                        $("#berkas3").val(visi_misi.berkas);
                                                                        $("#judul3").summernote('code', visi_misi.judul);
                                                                    ...
                                                                    $("#hapusDataForm").submit(function (e){
                                                                        ...
                                                                        let _token = $("input[name=_token]").val();
                                                                        $.ajax({
                                                                            url:"{{route('visi_misi.delete_data')}}",
                                                                            type: "PUT",
                                                                            data:{
                                                                                id:id,
                                                                                berkas:berkas,
