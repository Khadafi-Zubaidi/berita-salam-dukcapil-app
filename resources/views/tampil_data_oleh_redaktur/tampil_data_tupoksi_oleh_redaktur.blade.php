                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Data Dasar Hukum Tugas Pokok dan Fungsi</h5>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach($DataTabel as $dt)
                                                            ...
                                                            <script>
                                                                ...
                                                                {
                                                                    $.get('/tupoksis/'+id,function(tupoksi){
                                                                        $("#id1").val(tupoksi.id);
                                                                        $("#nama_peraturan1").summernote('code', tupoksi.nama_peraturan);
                                                                    ...
                                                                    $("#ubahDataForm").submit(function (e){
                                                                        ...
                                                                        $.ajax({
                                                                            ...
                                                                            success:function(response){
                                                                                ...
                                                                                window.location = "{{route('tampil_data_tupoksi_oleh_redaktur')}}";
                                                                            }
                                                                        })
                                                                    })
                                                                }
