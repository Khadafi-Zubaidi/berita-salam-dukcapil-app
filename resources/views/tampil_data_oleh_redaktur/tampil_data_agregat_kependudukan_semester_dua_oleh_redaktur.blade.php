                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            <li class="nav-item">
                                <a href="{{route('tambah_data_agregat_kependudukan_semester_dua_oleh_redaktur')}}" class="nav-link">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Data Agregat Kependudukan Semester Dua</h5>
                                                        ...
                                                        @foreach($DataTabel as $dt)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="/data_agregat_semester_dua/{{$dt->berkas}}" target="_blank" class="btn btn-success btn-block btn-sm">Lihat Berkas</a>
                                                            ...
                                                            <script>
                                                                ...
                                                                {
                                                                    $.get('/agregat_kependudukan_semester_dua/'+id,function(agregat_kependudukan_semester_dua){
                                                                        $("#id1").val(agregat_kependudukan_semester_dua.id);
                                                                        $("#judul1").summernote('code', agregat_kependudukan_semester_dua.judul);
                                                                    ...
                                                                    $("#ubahDataForm").submit(function (e){
                                                                        ...
                                                                        $.ajax({
                                                                            url:"{{route('agregat_kependudukan_semester_dua.update_data')}}",
                                                                            type: "PUT",
                                                                            data:{
                                                                                id:id,
                                                                                judul:judul,
                                                                            ...
                                                                            success:function(response){
                                                                                ...
                                                                                window.location = "{{route('tampil_data_agregat_kependudukan_semester_dua_oleh_redaktur')}}";
                                                                            }
                                                                        })
                                                                    })
                                                                }
                                                            ...
                                                            <script>
                                                                ...
                                                                {
                                                                    $.get('/agregat_kependudukan_semester_dua/'+id,function(agregat_kependudukan_semester_dua){
                                                                        $("#id2").val(agregat_kependudukan_semester_dua.id);
                                                                    ...
                                                                    $("#editDataFotoForm").submit(function (e){
                                                                        ...
                                                                        $.ajax({
                                                                            url:"{{route('agregat_kependudukan_semester_dua.update_berkas')}}",
                                                                            type: "POST",
                                                                            data: formData,
                                                                            cache:false,
                                                                            contentType: false,
                                                            ...
                                                            <script>
                                                                ...
                                                                {
                                                                    $.get('/agregat_kependudukan_semester_dua/'+id,function(agregat_kependudukan_semester_dua){
                                                                        $("#id3").val(agregat_kependudukan_semester_dua.id);
                                                                        $("#berkas3").val(agregat_kependudukan_semester_dua.berkas);
                                                                        $("#judul3").summernote('code', agregat_kependudukan_semester_dua.judul);
                                                                    ...
                                                                    $("#hapusDataForm").submit(function (e){
                                                                        ...
                                                                        let _token = $("input[name=_token]").val();
                                                                        $.ajax({
                                                                            url:"{{route('agregat_kependudukan_semester_dua.delete_data')}}",
                                                                            type: "PUT",
                                                                            data:{
                                                                                id:id,
                                                                                berkas:berkas,
