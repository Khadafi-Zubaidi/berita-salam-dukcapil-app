                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-7">
                        <div align="center">
                            ...
                            <br>
                            <h3>Login <strong>Operator KUA</strong></h3>
                            <h5>Aplikasi Salam Dukcapil</h5>
                        </div>
                        <form action="{{route('cek_login_operator_kua')}}" method="post">
                            @csrf
                            <div class="result">
                            ...
                            <div class="form-group first">
                                <label for="id_operator_kua">ID Operator</label>
                                <input name="id_operator_kua" type="text" class="form-control @error('id_operator_kua') is-invalid @enderror" placeholder="ID Operator" id="id_operator_kua">
