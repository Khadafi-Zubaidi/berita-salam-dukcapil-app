...
@section('content')
    ...
    <div class="d-lg-flex half">
        <div class="bg order-1 order-md-2" style="background-image: url('logintheme/images/login_berita.jpg');"></div>
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-7">
                        <div align="center">
                            ...
                            <br>
                            <h3>Login <strong>Redaktur</strong></h3>
                            <h5>Web Berita Salam Dukcapil</h5>
                        </div>
                        <form action="{{route('cek_login_redaktur')}}" method="post">
                            @csrf
                            <div class="result">
