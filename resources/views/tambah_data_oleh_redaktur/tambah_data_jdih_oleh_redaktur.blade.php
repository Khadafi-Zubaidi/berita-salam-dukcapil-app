                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Pemasukan Data JDIH</h5>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form action="{{route('simpan_data_baru_jdih_oleh_redaktur')}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <label>Nama Peraturan *</label><br>
                                                    <div class="input-group mb-3">
                                                        <div class="input-group mb-3">
                                                            <textarea name="nama_peraturan"id="summernote"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="input-group mb-3">
