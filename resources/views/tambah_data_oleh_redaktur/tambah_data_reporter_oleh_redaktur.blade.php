                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Pemasukan Data Reporter</h5>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form action="{{route('simpan_data_baru_reporter_oleh_redaktur')}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <label>NIP/ID PTT *</label><br>
