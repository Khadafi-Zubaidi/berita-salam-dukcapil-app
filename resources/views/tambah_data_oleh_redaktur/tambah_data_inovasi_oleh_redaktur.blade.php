                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Pemasukan Data Inovasi</h5>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form action="{{route('simpan_data_baru_inovasi_oleh_redaktur')}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <label>Nama Inovasi *</label><br>
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="nama_inovasi" class="form-control @error('nama_inovasi') is-invalid @enderror" value="{{ old('nama_inovasi')}}">
