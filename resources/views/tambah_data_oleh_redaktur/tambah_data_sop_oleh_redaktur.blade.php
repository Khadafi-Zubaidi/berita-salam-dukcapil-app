                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Pemasukan Data SOP</h5>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form action="{{route('simpan_data_baru_sop_oleh_redaktur')}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <label>Nama SOP *</label><br>
                                                    <div class="input-group mb-3">
                                                        <div class="input-group mb-3">
                                                            <textarea name="nama_sop"id="summernote"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="input-group mb-3">
