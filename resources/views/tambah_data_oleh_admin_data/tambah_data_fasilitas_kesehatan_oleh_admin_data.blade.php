                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form action="{{route('simpan_data_baru_fasilitas_kesehatan_oleh_admin_data')}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="nama_fasilitas_kesehatan" class="form-control @error('nama_fasilitas_kesehatan') is-invalid @enderror" value="{{ old('nama_fasilitas_kesehatan')}}">
