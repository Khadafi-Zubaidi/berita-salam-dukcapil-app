                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Pemasukan Data Desa Kelurahan</h5>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form action="{{route('simpan_data_baru_desa_kelurahan_oleh_admin_data')}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="kode_wilayah_desa_kelurahan" class="form-control @error('kode_wilayah_desa_kelurahan') is-invalid @enderror" value="{{ old('kode_wilayah_desa_kelurahan')}}">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="text" name="nama_desa_kelurahan" class="form-control @error('nama_desa_kelurahan') is-invalid @enderror" value="{{ old('nama_desa_kelurahan')}}">
                                                        <div class="input-group-append">
                                                            <div class="input-group-text">
                                                                <span class="fas fa-id-card"></span>
                                                            </div>
