                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Pemasukan Data Operator Fasilitas Kesehatan</h5>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form action="{{route('simpan_data_baru_operator_fasilitas_kesehatan_oleh_admin_data')}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">
                                                        <label>Nama Fasilitas Kesehatan *</label>
                                                            <select name="id_fasilitas_kesehatan" class="form-control select2" style="width: 100%;">
                                                                @foreach($DataFasilitasKesehatan as $dt1)
                                                                    <option value="{{$dt1->id}}">{{$dt1->nama_fasilitas_kesehatan}} - {{$dt1->nama_kecamatan}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    <label>ID Operator *</label><br>
                                                    <div class="input-group mb-3">
                                                        <input type="number" name="id_operator_fasilitas_kesehatan" class="form-control @error('id_operator_fasilitas_kesehatan') is-invalid @enderror" value="{{ old('id_operator_fasilitas_kesehatan')}}">
